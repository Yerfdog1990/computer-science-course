                                    ...
                                    How have you been? I was...
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                            class="contacts-list-img"
                                                            src="includes/assets/img/user7-128x128.jpg"
                                                            alt="User Avatar"
                                                    />
                                    ...
                                    <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                            class="contacts-list-img"
                                                            src="includes/assets/img/user5-128x128.jpg"
                                                            alt="User Avatar"
                                                    />
                                    ...
                                    <small class="contacts-list-date float-end"> 2/10/2023 </small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                            class="contacts-list-img"
                                                            src="includes/assets/img/user6-128x128.jpg"
                                                            alt="User Avatar"
                                                    />
                                ...
                                <div class="card-body p-0">
                                    <div class="row text-center m-1">
                                        ...
                                        <div class="col-3 p-2">
                                            <img
                                                    class="img-fluid rounded-circle"
                                                    src="includes/assets/img/user4-128x128.jpg"
                                                    alt="User Image"
                                            />
                                            <a
                                                    class="btn fw-bold fs-7 text-secondary text-truncate w-100 p-0"
                        ...
                        <div class="card-body p-0">
                            <div class="px-2">
                                <div class="d-flex border-top py-2 px-1">
                                    <div class="col-2">
                                        <img
                                                src="includes/assets/img/default-150x150.png"
                                                alt="Product Image"
                                                class="img-size-50"
                                        />
                                    </div>
