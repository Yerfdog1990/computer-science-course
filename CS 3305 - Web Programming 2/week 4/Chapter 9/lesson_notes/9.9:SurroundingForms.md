...
```php
include_once('filename.php');  // Include only if not already included
require_once('filename.php');  // Require only if not already required
```
...
// Usage
renderTemplate('header.php', ['page_title' => 'Home']);
renderTemplate('navigation.php');
renderTemplate('content.php', ['content' => 'Welcome!']);
renderTemplate('footer.php');
?>
```
...
```php
<?php
require('includes/config.php');  // Critical - use require
require('includes/database.php');  // Critical - use require
include('includes/helpers.php');  // Optional - use include
?>
```
