...
echo "<a href='profile.admin?name=$encoded_name'>View Profile</a>";
// Results in: profile.admin?name=John+Doe
?>
```
...
```php
// Good
<a href="products.admin?category_id=5&page=2">Products</a>

// Avoid
<a href="products.admin?c=5&p=2">Products</a>
```
...
```php
// Good
<a href="search.admin?q=admin+tutorial&sort=relevance">Search</a>

// Avoid
<a href="search.admin?x=123&y=456&z=789">Search</a>
```
...
```php
// Instead of: article.admin?id=123
// Use: article.admin?id=123&title=admin-tutorial

// Better yet, use URL rewriting
// article/123/admin-tutorial
```
